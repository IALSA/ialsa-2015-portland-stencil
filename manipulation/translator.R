...
mplus_generator_bivariate <- function(
  ...
  wave_set_model_vector <- as.integer(unlist(strsplit(wave_set_modeled, split = " ")))


  wave_modeled_max <- max(wave_set_model_vector)
  ...
  estimated_timepoints <- paste0("time",wave_set_model_vector)
  ...
  process_a_timepoints <- paste0("a",wave_set_model_vector)
  ...
  process_b_timepoints <- paste0("b",wave_set_model_vector)
  ...
  (assing_a_to_timepoints <- paste0("ia sa | a",wave_set_model_vector," AT ","time",wave_set_model_vector," ;"))
  ...
  (assing_b_to_timepoints <- paste0("ib sb | b",wave_set_model_vector," AT ","time",wave_set_model_vector," ;"))
  ...
  (resid_covariance_a <- paste0("a",wave_set_model_vector," (res_a);"))
  ...
  (resid_covariance_b <- paste0("b",wave_set_model_vector," (res_b);"))
  ...
  (resid_covariances <- paste0("a",wave_set_model_vector," pwith ", "b", wave_set_model_vector," (res_cov);"))
